...
//  logic_error
//
//  Created by Yunus Chang on 10/2/18.
...
int main()
{
    ...
    double pctNewsom = 100.0 * numberSurveyed / forNewsom;//swapped numberSurveyed and forNesom
    double pctCox = 10.0 * forCox / numberSurveyed;//reduced 100.0 to 10.0
